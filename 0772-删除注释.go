...
func main() {
	...
	//source := []string{"a/*Test program */b", "int main()", "{ ", "  // variable declaration ", "int a, b, c;", "/* This is a test", "   multiline  ", "   comment for ", "   testing */", "a = b + c;", "}"}
	//source := []string{"a//*b//*c","blank","d/*/e*//f"}
	source := []string{"a/*/b//*c","blank","d/*/e*//f"}
	for _,value := range removeComments(source) {
		fmt.Printf("%s\n", value)
	}
}
